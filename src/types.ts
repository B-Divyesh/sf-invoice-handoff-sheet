...
export const sampleSheet = (): Sheet => ({
  ...
  milestones: [
    { id: 'm1', title: 'Final responsive site delivered', deliveredOn: '2026-08-09', evidence: new URL('/sample-proofs/moonbeam-final-preview.html', location.origin).href, acceptedBy: 'Taylor Morgan', acceptedOn: '2026-08-10' },
    { id: 'm2', title: 'Source files and handover notes delivered', deliveredOn: '2026-08-10', evidence: new URL('/sample-proofs/moonbeam-handover-files.html', location.origin).href, acceptedBy: '', acceptedOn: '' }
  ],
  followUps: [
