...
Navigation labels and the wordmark are omitted from sentence-length checks.
...
| Final site delivered | 3 | Pass |
| Taylor accepted review | 3 | Pass |
| Follow-up sent Aug 25 | 4 | Pass |
| HOW IT WORKS | 3 | Pass |
| Make a record in three steps. | 7 | Pass |
| Add the delivery. | 3 | Pass |
| List each milestone and its proof link. | 7 | Pass |
...
| Start a handoff | 3 | Pass |
| Clear delivery and payment records for independent work. | 8 | Pass |
...
| --- | --- |
| The core record | handoff |
| Work sent to the client | delivery milestone |
| Supporting URL | delivery proof |
| Payment request | invoice |
| Client contact history | follow-up log |
| Sample mode | demo |
